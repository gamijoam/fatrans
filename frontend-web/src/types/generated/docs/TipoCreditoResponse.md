...
```typescript
import type { TipoCreditoResponse } from ''
...
const example = {
  ...
  "penalidadMoraTasa": null,
  "diasGracia": null,
  "activo": null,
} satisfies TipoCreditoResponse
...
const exampleParsed = JSON.parse(exampleJSON) as TipoCreditoResponse
