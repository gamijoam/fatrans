...
const adminMenuItems = [
  ...
  { icon: Activity, label: 'Transacciones', href: '/admin/transacciones' },
  { icon: FileText, label: 'Solicitudes', href: '/admin/solicitudes' },
  { icon: CreditCard, label: 'Créditos', href: '/admin/creditos' },
  { icon: PackageOpen, label: 'Productos', href: '/admin/productos' },
...
const mockNotifications: Notification[] = [
  { id: '1', title: 'Nueva solicitud', message: 'Solicitud de crédito pendiente', time: 'Hace 5 min', read: false },
  { id: '2', title: 'KYC aprobado', message: 'Verificación completada', time: 'Hace 1 hora', read: false },
  { id: '3', title: 'Depósito recibido', message: 'Bs 5,000,000 depositados', time: 'Hace 2 horas', read: true },
];
      ...
      <div className="flex h-screen bg-slate-100">
        ...
        <aside className="hidden lg:flex w-64 bg-[#0F2744] text-white flex-col fixed h-full z-40">
          ...
          <div className="p-3 border-t border-white/10">
            <LogoutButton variant="ghost" className="w-full justify-start text-white/70 hover:text-white hover:bg-white/10" />
          </div>
        </aside>
